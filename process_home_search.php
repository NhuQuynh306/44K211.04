...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="home_header_main">
            <div id="home_header">
                <div class="home_logo"><a href="index.php" class=""><a href="index.php"><img src="images/large_logo.png" width="180" /></a></a></div>
        ...
        <div class="home_banner_main">
            <div id="home_banner_search">
                <div id="reg_maindiv">
                    <div class="reg_left">
                        <div style="width:750px; height:auto; margin:10px; font-family:Arial; font-size:13px;">
                            <table width="100%" cellpadding="5" cellspacing="0">
                                ...
                                <?php
                                    ...
                                    $query = "select * from jobs where j_title LIKE '%$keyword%' or j_city LIKE '%$keyword2%' or j_company LIKE '%$keyword%'";
                                    //echo $query ; die();
                                    ...
                                    if($result){ 
                                        ...
                                        if(mysqli_affected_rows($connect)!=0){
                                            echo '<tr style="background:#F7F7F7;">
                                                    ...
                                                    <td width="74%" style="border-bottom:none; border-right:none;">Chức vụ / Công việc</td>
                                                    <td width="13%" style="border-bottom:none;">Hết hạn vào</td>
                                                </tr>';
                                              while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)){
                                        echo
                                    	'<tr class="mouse">
                                    <td style="color:#B30000; text-align:center;">'.$row['j_id'].' </td>
