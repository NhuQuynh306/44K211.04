<?php
    ...
    $q1="INSERT INTO `employees`(`ee_email`, `ee_password`, `ee_fname`, `ee_lname`, `ee_day`, `ee_month`, `ee_year`, `ee_gender`,`ee_city`, `ee_education`, `ee_mnumber`, `ee_experience`, `ee_skills`, `ee_industry`, `ee_certification`, `ee_path`) VALUES ('$email','$password','$fname','$lname','$day','$month','$year','$gender','$city','$education','$mnumber','$experience','$skills','$industry','$certification','$path')";
    ...
    $display = ' ';
    if ($result) {
      $display = '<h2>Tạo hồ sơ thành công !</h2>';
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                            <td height="auto" style="padding:0px;">
                                <input type="text" placeholder="Nhập Email của bạn" class="login_select" required
                                    name="email" 
                        ...
                        <tr>
                            <td height="auto"><input type="text" placeholder="Mật khẩu" required
                                class="login_select"
                                name="Password" 
                                onblur="if(value=='') value = ''" 
                                onfocus="if(value=='') value = ''"/></td>
                        </tr>
                        <tr> <input type="hidden" name="Login" value="Login">
