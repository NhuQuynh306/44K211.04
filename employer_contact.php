                ...
                <div class="employee_login_div_reg">
                    <div class="employee_login">
                        <div class="employee_register" style="background:url(images/reg-bg.png) repeat;">
                            ...
                            <span style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#2699d6; font-size:17px;">Liên hệ</span>
                            <table width="100%" cellspacing="10" cellpadding="5">
                                <tr>
                                    <td width="34%"><span class="advanced_star">&nbsp;&nbsp;&nbsp;</span><span class="em_reg_star">*</span> Tên</td>
                                    <td width="2%">:</td>
                                    <td width="64%"><input type="text" placeholder="Nhập tên" required
                                        name="jobtitle2" 
                                        onblur="if(value=='') value = ''" 
                                        onfocus="if(value=='') value = ''" class="em_reg_box" /></td>
                                </tr>
                                <tr>
                                    <td><span class="advanced_star">&nbsp;&nbsp;&nbsp;</span><span class="em_reg_star">*</span> Email</td>
                                    <td>:</td>
                                    <td><input type="text" placeholder="Nhập Email" required
                                        name="jobtitle3" 
                                        onblur="if(value=='') value = ''" 
                                        onfocus="if(value=='') value = ''" class="em_reg_box" /></td>
                                </tr>
                                <tr>
                                    <td><span class="advanced_star">&nbsp;&nbsp;&nbsp;</span><span class="em_reg_star">*</span> Chủ đề</td>
                                    <td>:</td>
                                    <td><input type="text" placeholder="Chủ đề" required
                                        name="jobtitle" 
                                        onblur="if(value=='') value = ''" 
                                        onfocus="if(value=='') value = ''" class="em_reg_box" /></td>
                                </tr>
                                <tr>
                                    <td width="34%"><span class="advanced_star">&nbsp;&nbsp;&nbsp;</span><span class="em_reg_star">*</span> Nội dung </td>
                                    <td width="2%">:</td>
                                    <td width="64%"><textarea name="textarea" cols="" rows="" class="em_address" required></textarea></td>
                                </tr>
                                <td colspan="3" style="text-align:center;">
                                    <input type="hidden" name="Submit" value="Submit">
                                    <input type="submit" value="Gửi"  style="background:url(images/button.png) no-repeat; width:100px; height:25px; border:none; color:#fff;" />
                                </td>
                                </tr>
                                <tr>
