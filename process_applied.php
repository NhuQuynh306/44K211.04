...
if($applied==1)
{
  echo 'Bạn đã ứng tuyển thành công cho công việc này<br><br>';
  echo '<a href="jobseeker_home.php">Quay trở lại trang chủ</a>';  
}
else if($applied==0)
{
  echo 'Bạn đã nộp CV vào công việc này ...<br><br>';
  echo '<a href="jobseeker_home.php"> Quay lại trang chủ để tìm kiếm công việc khác </a>';  
}
else if($applied==2)
{
  echo 'Đã xảy ra lỗi, không được áp dụng<br><br>';
  echo '<a href="jobseeker_home.php">Quay trở lại trang chủ</a>';  
}
else {
  echo ' ';
...
<?php if($applied != 0 && $applied != 1 && $applied != 2 ) { ?>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 />    </td>
  ...
  <tr>
    <td height="auto"><input type="text" placeholder="Mật khẩu"
  class="login_select"
   name="Password" 
    onblur="if(value=='') value = ''" 
    onfocus="if(value=='') value = ''"/></td>
  </tr>
  <tr><input type="hidden" value="Login" />
