...
error_reporting(E_ERROR | E_PARSE);
    ...
    er_city,er_country,er_website,er_TNumber,er_title,er_fname,er_lname,er_designation,er_contactemail,
    er_MNumber,er_active) VALUES('$company','$companytype','$sector','$category','$companyemail','$password','$address','$city','$country','$website','$TNumber','$title','$fname','$lname','$designation','$contactemail','$MNumber',0)";
    
    // echo $q; die();
    $result1=mysqli_query($connect,$q)or die("wrong query");
